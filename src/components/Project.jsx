      ...
      <div className="w-full">
        <div className="flex flex-col md:flex-row justify-between px-10 gap-5 mb-6">
            ...
            <div className="project-desc">
              ...
              <div className="flex justify-center">
                <a
                  className="btn"
                  target="_blank"
                  href="https://github.com/Ragulr24/ecommerce"
                >
                  View Project
                </a>
              </div>
          ...
          <div className="relative">
            ...
            <div className="project-desc">
              <p className="text-center md:py-2 text-black font-bold">
                Junior Developer in FR8 [May 2022 - Oct 2022]
              </p>
              <ul>
              ...
              <p className="md:py-6">
                <b>TechStack used: </b>React.js, JavaScript (ES6+), HTML, CSS,
                RESTful APIs,Version Control.
              </p>
            </div>
          </div>
          <div className="relative">
            ...
            <div className="project-desc ">
              <p className="text-center md:py-2 text-black font-bold">
                Senior Developer in FR8 [Oct 2022 - Oct 2023]
              </p>
              <ul>
                <li className="list-disc pl-2">
              ...
              <p className="md:py-6">
                <b>TechStack used: </b>React.js, JavaScript (ES6+), Redux, HTML,
                CSS, RESTful APIs,Version Control.
              </p>
            </div>
          </div>
        </div>
